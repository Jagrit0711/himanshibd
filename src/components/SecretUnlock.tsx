...
const SecretUnlock = ({
  ...
  return <div className="py-12 relative">
      ...
      <Card className="mx-auto max-w-2xl p-8 bg-gradient-to-br from-pink-100 to-white rounded-3xl border-4 border-pink-300 shadow-[8px_8px_0px_0px_rgba(236,72,153,0.3)] relative z-10">
        <div className="text-black">
          ...
          <div className="space-y-4 text-center">
            {!isPlaying ? <button onClick={playMessage} className="bg-pink-400 text-white px-6 py-3 font-bold text-lg rounded-full border-2 border-pink-500 shadow-[5px_5px_0px_0px_rgba(236,72,153,0.3)] hover:translate-y-1 hover:shadow-[4px_4px_0px_0px_rgba(236,72,153,0.3)] transition-all">
                Play Secret Message
              </button> : <div className="animate-pulse">
                <p className="text-xl">Playing message...</p>
                <div className="flex justify-center gap-2 mt-2">
                  {[...Array(3)].map((_, i) => <div key={i} className="w-3 h-3 bg-pink-400 rounded-full animate-bounce" style={{
      ...
      {/* Decorative elements */}
      <div className="absolute -bottom-10 left-1/4 text-5xl animate-bounce-mild" style={{
      animationDuration: "4s"
    }}>
        ✨
      </div>
      <div className="absolute top-20 right-1/4 text-5xl animate-bounce-mild" style={{
